...
public interface IDomainServiceBase<TModel, TRequest> where TModel : IModel where TRequest : class, IRequest
{
	Task<PaginatedModel<TModel>> GetAllAsync(Search<TRequest> search);
